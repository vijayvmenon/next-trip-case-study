        ...
        <tr className={clsx(classes.tableRow, classes.clickable)}>
          <td colSpan={columns.length}>
            ...
            >
              ...
              <p className={classes.iconText}>{translations.SHOW_MORE}</p>
            </div>
          </td>
        </tr>
      )}
...
CollapsedRow.propTypes = {
  ...
  rowsToShow: PropTypes.arrayOf(PropTypes.any).isRequired,
